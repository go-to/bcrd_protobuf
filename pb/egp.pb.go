...
var file_egp_proto_rawDesc = []byte{
	...
	,
	...
	0x54, 0x41, 0x49, 0x4c, 0x10, 0x04, 0x32, 0x3f, 0x0a, 0x0a, 0x45, 0x67, 0x70, 0x53, 0x65, 0x72,
...
var file_egp_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_egp_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_egp_proto_goTypes = []any{
	(SearchType)(0),       // 0: egp.SearchType
	(*Date)(nil),          // 1: egp.Date
	(*Event)(nil),         // 2: egp.Event
	(*Category)(nil),      // 3: egp.Category
	(*Categories)(nil),    // 4: egp.Categories
	(*BeerType)(nil),      // 5: egp.BeerType
	(*BeerTypes)(nil),     // 6: egp.BeerTypes
	(*Shop)(nil),          // 7: egp.Shop
	(*ShopLocation)(nil),  // 8: egp.ShopLocation
	(*ShopTime)(nil),      // 9: egp.ShopTime
	(*ShopsRequest)(nil),  // 10: egp.ShopsRequest
	(*ShopsResponse)(nil), // 11: egp.ShopsResponse
}
var file_egp_proto_depIdxs = []int32{
	1,  // 0: egp.Event.StartDate:type_name -> egp.Date
	1,  // 1: egp.Event.EndDate:type_name -> egp.Date
	3,  // 2: egp.Categories.Categories:type_name -> egp.Category
	5,  // 3: egp.BeerTypes.BeerTypes:type_name -> egp.BeerType
	6,  // 4: egp.Shop.BeerTypes:type_name -> egp.BeerTypes
	0,  // 5: egp.ShopsRequest.SearchTypes:type_name -> egp.SearchType
	7,  // 6: egp.ShopsResponse.Shops:type_name -> egp.Shop
	10, // 7: egp.EgpService.GetShops:input_type -> egp.ShopsRequest
	11, // 8: egp.EgpService.GetShops:output_type -> egp.ShopsResponse
